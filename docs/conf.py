#!/usr/bin/env python
"""
freemace documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "freemace"))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, ".."))
sys.path.insert(0, src_path)


import freemace.core  # noqa
...
project = "freemace"
_full_version = freemace.core.__version__
author = freemace.core.__author__
copyright = freemace.core.__copyright__
...
htmlhelp_basename = "freemace-doc"
